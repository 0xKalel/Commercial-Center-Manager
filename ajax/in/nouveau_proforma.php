...
function insertion($libelle,$nom,$date,$date_debut,$date_fin,$montant,$autre_declaration) {
	...
	if($bdd->query(
		   "INSERT INTO proforma(local,locataire,date_debut,date_fin,montant,autre_declaration,date) VALUES ('$libelle','$nom','$date_debut','$date_fin','$montant','$autre_declaration','$date_contrat')"
	    )
	)
		echo $bdd->insert_id;
	else
